<?php
  ...
  /**
   * CodeRobot_Sniffs_Whitespace_ScopeIndentSniff.
   *
   * Checks that control structures are structured correctly, and their content
   * is indented correctly. This sniff will throw errors if tabs are used
   * for indentation rather than spaces.
   */
  class CodeRobot_Sniffs_WhiteSpace_ScopeIndentSniff implements PHP_CodeSniffer_Sniff {
    ...
    protected function calculateExpectedIndent(array $tokens, $stackPtr) {
      ...
      if(empty($tokens[$stackPtr]['conditions']) === TRUE) {
        return 3; // 1 + 2 spaces inside php tags
      }
      ...
      return ((count($conditionStack) * $this->indent) + 3); // 1 + 2 spaces inside classes, functions, etc
    }
